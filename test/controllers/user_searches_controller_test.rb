...
class UserSearchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_search" do
    assert_difference("UserSearch.count") do
      post user_searches_url, params: { user_search: { date_search: @user_search.date_search, make: @user_search.make, model: @user_search.model, price_from: @user_search.price_from, price_to: @user_search.price_to, user_id: @user_search.user_id, year_from: @user_search.year_from, year_to: @user_search.year_to } }
    end
  ...
  test "should update user_search" do
    patch user_search_url(@user_search), params: { user_search: { date_search: @user_search.date_search, make: @user_search.make, model: @user_search.model, price_from: @user_search.price_from, price_to: @user_search.price_to, user_id: @user_search.user_id, year_from: @user_search.year_from, year_to: @user_search.year_to } }
